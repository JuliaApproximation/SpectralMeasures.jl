## These are the figures that appear in the paper
# "Spectra of Jacobi operators via connection coefficients" by Marcus Webb and Sheehan Olver (2018)
...
for n in [1,2,3,10,50,100]
  ...
  R = principalresolvent(aRand,Float64[])
